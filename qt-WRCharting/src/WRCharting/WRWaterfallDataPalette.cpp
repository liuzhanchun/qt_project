...
//初始化颜色表。
void WRWaterfallDataPalette::initialize(void)
{
    int index1 = 0;
...
//清理当前对象所占用的相关资源。
WRWaterfallDataPalette::~WRWaterfallDataPalette()
{
	delete[] m_list;
}
//获取默认颜色。
WRWaterfallDataPalette* WRWaterfallDataPalette::defaultPalette(void)
{
	static WRWaterfallDataPalette value;
	return &value;
}
